...
export type GetConversationQuery = { __typename?: 'Query', getConversation: Array<{ __typename?: 'Message', id: number, createdAt: any, text: string, sender: { __typename?: 'Persona', id: number } }> };
