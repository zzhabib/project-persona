...
export type GetStorySessionQuery = { __typename?: 'Query', getStorySession: { __typename?: 'StorySession', id: number, name: string, story: { __typename?: 'Story', id: number, title: string, description: string, personas: Array<{ __typename?: 'Persona', name: string, id: number, description: string }> } } };
...
export type GetConversationQuery = { __typename?: 'Query', getConversation: Array<{ __typename?: 'Message', id: number, createdAt: any, text: string, sender: { __typename?: 'Persona', id: number, name: string } }> };
