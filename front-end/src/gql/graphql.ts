...
export type RolesQuery = { __typename?: 'Query', getScene: { __typename?: 'Scene', roles: Array<{ __typename?: 'Role', description: string, actions: Array<{ __typename?: 'Action', name: string, id: number }> }> } };
