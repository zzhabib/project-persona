...
{
    [SerializeField, Tooltip(("Your OpenAI API key. If you use a restricted key, please ensure that it has permissions for /v1/audio."))] private string openAIKey = "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";
